...
import { MessageSquare, X, Send, Bot, User, Zap, Search, Smartphone, FileText, Loader2 } from 'lucide-react';
                    ...
                    <div className="chatbot-header">
                        <div className="chatbot-header-left">
                            <div className="chatbot-header-icon">
                                <img src={logo} alt="WebAudit AI" className="chatbot-header-logo" />
                            </div>
                            <div>
